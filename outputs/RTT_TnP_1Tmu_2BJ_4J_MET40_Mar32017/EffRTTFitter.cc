...

{
  ...
  PlotDataVsMC(h_pass_bkg1, h_pass_bkg2, h_pass_signal, histPass,"TemplatesandData_Passsample_beforefit_mt.png", true);   
  PlotDataVsMC(h_fail_bkg1, h_fail_bkg2, h_fail_signal, histFail, "TemplatesandData_Failsample_beforefit_mt.png", false);
  ...
  PlotDataVsMC(h_pass_bkg1_af, h_pass_bkg2_af, h_pass_signal_af, histPass,"TemplatesandData_Passsample_afterfit_mt.png", true);   
  PlotDataVsMC(h_fail_bkg1_af, h_fail_bkg2_af, h_fail_signal_af, histFail, "TemplatesandData_Failsample_afterfit_mt.png", false);
