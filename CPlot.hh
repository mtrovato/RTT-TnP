...
// void Clear(){}
  ...
  void AddPlotItem(CPlotItem item, TString label, TString legopt);  

  // Adding a 1D histogram to the plot
  void AddHist1D(TH1D *h, TString drawopt="", int color=kBlack, int linesty=1, int fillsty=0, int linewidth=2);
  void AddHist1D(TH1D *h, TString label, TString drawopt, int color=kBlack, int linesty=1, int fillsty=0, int linewidth=2);
  void AddHist1D(TFile *f, TString histName, TString drawopt="", int color=kBlack, int linesty=1, int fillsty=0, int linewidth=2);
  void AddHist1D(TFile *f, TString histName, TString label, TString drawopt, int color=kBlack, int linesty=1, int fillsty=0, int linewidth=2);
  ...
  void AddFcn2D(TF2* fcn, int color=kBlack, int linesty=1);
...
protected:
  ...
  vector<TF2*> fFcns2D; //list of 2D functions
